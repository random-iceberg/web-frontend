...
describe('Input Component', () => {
  ...
  it('renders correctly with basic props (text type)', () => {
    const { asFragment } = render(
      <Input id="test-input" label="Test Label" value="Test Value" onChange={mockOnChange} />
    );
  ...
  it('renders correctly when disabled', () => {
    const { asFragment } = render(
      <Input id="test-input" label="Test Label" value="Test Value" onChange={mockOnChange} disabled />
    );
    expect(asFragment()).toMatchSnapshot();
  });
  ...
  it('renders correctly when required', () => {
    const { asFragment } = render(
      <Input id="test-input" label="Test Label" value="Test Value" onChange={mockOnChange} required />
    );
    expect(asFragment()).toMatchSnapshot();
  });
  ...
  it('calls onChange handler when text is entered', () => {
    const { getByLabelText } = render(
      <Input id="test-input" label="Test Label" value="" onChange={mockOnChange} />
    );
  ...
  it('does not call onChange handler when disabled and text is entered', () => {
    const { getByLabelText } = render(
      <Input id="test-input" label="Test Label" value="" onChange={mockOnChange} disabled />
    );
    const inputElement = getByLabelText('Test Label') as HTMLInputElement;
