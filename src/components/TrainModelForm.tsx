...
const TrainModelForm: React.FC = () => {
  ...
  return (
    <form className="bg-gray-50 p-6 rounded-lg shadow" onSubmit={handleSubmit}>
      <div className="mb-6">
        <label htmlFor="model-name" className="block mb-2 font-medium text-gray-700">
          Model Name:
        </label>
        <input
          id="model-name"
      ...
      <div className="mb-6">
        <label htmlFor="algorithm" className="block mb-2 font-medium text-gray-700">
          Algorithm:
        </label>
        <select
          id="algorithm"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {AVAILABLE_FEATURES.map(feature => (
            <div key={feature.id} className="flex items-center">
              ...
              />
              <label htmlFor={`feature-${feature.id}`} className="ml-2 text-gray-700">
                {feature.label}
              </label>
            </div>
          ))}
