      ...
      <nav className="bg-accent">
        <div className="container mx-auto flex items-center justify-between pr-2">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-3xl font-bold text-white">Titanic Survival Predictor</span>
          </Link>

          {/* Navigation Links */}
          <div className="hidden md:flex space-x-4 text-xl font-bold text-white">
            <ul className="flex space-x-6">
              <li><Link to="/calculator" className="hover:text-secondary">Survival Calculator</Link></li>
              <li><Link to="/admin" className="hover:text-secondary">Admin Console</Link></li>
            </ul>
          </div>
