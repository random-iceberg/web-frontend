    ...
    <header className="pb-5">
      <nav className="bg-accent">
        <div className="container mx-auto flex items-center justify-between pr-2">
          ...
          {/* Auth Buttons */}
          {/* Auth Buttons - Apply Button component styles */}
          <div className="flex items-center space-x-3">
            {/* Sign In - Apply secondary button styles */}
            <Link
              to="/signin"
              className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition ease-in-out duration-150 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-indigo-500" // secondary variant classes (adjusted text color from accent)
            >
              Sign In
            </Link>
            {/* Sign Up - Apply primary button styles */}
            <Link
              to="/signup"
              className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition ease-in-out duration-150 bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500 border border-transparent" // primary variant classes (adjusted text color from accent)
            >
              Sign Up
            </Link>
          </div>
